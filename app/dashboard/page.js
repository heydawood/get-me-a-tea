    ...
    <div className="flex justify-center items-center h-screen">
      <div className="w-[400px] p-4 bg-slate-900 rounded-lg shadow-lg">
        ...
        <form className="flex flex-col gap-2">
          ...
          <input type="text" className="p-3 rounded-lg bg-gray-800" placeholder="Enter Your Email" />
          <input type="text" className="p-3 rounded-lg bg-gray-800" placeholder="Enter Your Username" />
